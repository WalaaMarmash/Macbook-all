//
//  updateDelivaryCostViewController.swift
//  Transporter
//
...
class updateDelivaryCostViewController: UIViewController,UITextFieldDelegate {
    ...
    @IBAction func submitBtnPressed(_ sender: Any) {
        ...
        if PriceTextField.text == ""{
            ...
            self.present(alert, animated: true)
                  ...
                  TransporterLoader.TypeAction = "EditCost"
            
           
            
            TransporterLoader.NewCost =  PriceTextField.text!
            ...
            reachability.whenReachable = { reachability in
                ...
                DispatchQueue.main.async {
                    ...
                    self.transporterLoader.TransporterEditPriceTrip {
                     
                        UIViewController.removeSpinner(spinner: sv)
                        
                        if CheckCostPopupViewController.DeleteSubmitCostResult .contains("UpdatedOrder") {
